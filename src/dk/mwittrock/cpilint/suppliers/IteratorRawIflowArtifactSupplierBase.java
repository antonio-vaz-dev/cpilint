...
import dk.mwittrock.cpilint.artifacts.ExpandedZipArchiveIflowArtifact;
...
abstract class IteratorRawIflowArtifactSupplierBase implements IflowArtifactSupplier {
	...
	public IflowArtifact supply() {
		...
		try {
			iflow = ExpandedZipArchiveIflowArtifact.from(iterator.next());
